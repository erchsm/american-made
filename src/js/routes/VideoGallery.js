  ...
  render() {
    ...
    return (
      <div className={classnames}>
        ...
        <VideoGalleryItem title="Trailer 1" source="assets/img/videos_bg2.mp4" onclick={this.togglePlayerOpen}/>
        <VideoGalleryItem title="Trailer 2" source="assets/img/videos_bg4.mp4" onclick={this.togglePlayerOpen}/>
        <VideoGalleryItem title="Trailer 3" source="assets/img/videos_bg5.mp4" onclick={this.togglePlayerOpen}/>
        <VideoGalleryItem title="Trailer 4" source="assets/img/videos_bg3.mp4" onclick={this.togglePlayerOpen}/>
        <VideoGalleryItem title="Trailer 5" source="assets/img/videos_bg1.mp4" onclick={this.togglePlayerOpen}/>
        <VideoGalleryItem title="Trailer 6" source="assets/img/videos_bg0.mp4" onclick={this.togglePlayerOpen}/>
        </div>
