  ...
  render() {
    ...
    return (
      <div className={classnames}>
        ...
        <VideoGalleryItem title="Trailer 1" onclick={this.togglePlayerOpen} source="//american-made-a.nbcuxlab.com/img/_videos/videos_bg2.mp4" />
        <VideoGalleryItem title="Trailer 2" onclick={this.togglePlayerOpen} source="//american-made.nbcuxlab.com/design-guide/img/gallery/3.mp4" />
        <VideoGalleryItem title="Trailer 3" onclick={this.togglePlayerOpen} source="//american-made.nbcuxlab.com/design-guide/img/gallery/4.mp4" />
        <VideoGalleryItem title="Trailer 4" onclick={this.togglePlayerOpen} source="//american-made-a.nbcuxlab.com/img/_videos/videos_bg3.mp4" />
        <VideoGalleryItem title="Trailer 5" onclick={this.togglePlayerOpen} source="//american-made-a.nbcuxlab.com/img/_videos/videos_bg1.mp4" />
        <VideoGalleryItem title="Trailer 6" onclick={this.togglePlayerOpen} source="//american-made-a.nbcuxlab.com/img/_videos/videos_bg0.mp4" />
        </div>
